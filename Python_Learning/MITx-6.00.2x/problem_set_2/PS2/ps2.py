...
class RectangularRoom(object):
    ...
    def cleanTileAtPosition(self, pos):
        ...
        pos: a Position
        """
        pos_clean = (math.floor(pos.getX()), math.floor(pos.getY()))
        self.clean_status[pos_clean] = True
    ...
    def getNumCleanedTiles(self):
        ...
        """
        count_clean = 0
        for item in self.clean_status.values():
            if item:
                count_clean += 1
        return count_clean
...
class StandardRobot(Robot):
    ...
    def updatePositionAndClean(self):
        ...
        while not pass_check:
            pos_temp = self.position.getNewPosition(self.direction, self.speed)
            if self.room.isPositionInRoom(pos_temp):
...
#         anim = ps2_visualize.RobotVisualization(num_robots, width, height, 0.5)
        ...
        count_step = 0
        while test_space.getNumCleanedTiles() < (min_coverage * test_space.getNumTiles()):
...
#       (... your call here ...)
#
showPlot1('test', 'Number of Robots', 'Times')
#
...
#       (... your call here ...)
#
#showPlot2('Test', 'Ratio between width and height', 'Times')